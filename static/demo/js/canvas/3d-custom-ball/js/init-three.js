...
//绘制一个正方体，通过绘制所有边
function drawCube(x,y,z,r,color){
	var p1 = new THREE.Vector3( (x + r/2),(y + r/2),(z + r/2) );
	var p2 = new THREE.Vector3( (x + r/2),(y + r/2),(z - r/2) );
	var p3 = new THREE.Vector3( (x - r/2),(y + r/2),(z - r/2) );
	var p4 = new THREE.Vector3( (x - r/2),(y + r/2),(z + r/2) );
	var p5 = new THREE.Vector3( (x + r/2),(y - r/2),(z + r/2) );
	var p6 = new THREE.Vector3( (x + r/2),(y - r/2),(z - r/2) );
	var p7 = new THREE.Vector3( (x - r/2),(y - r/2),(z - r/2) );
	var p8 = new THREE.Vector3( (x - r/2),(y - r/2),(z + r/2) );
...
function  initXYZ(axisL,colorx,colory,colorz){
	//绘制X轴红色
